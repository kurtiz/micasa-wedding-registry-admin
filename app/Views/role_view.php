            ...
            <div class="main-content">
                <div class="container-fluid">
                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    ...
                                    <div class="d-inline">
                                        <h5>View User Role</h5>
                                        <span>View user role details in your shop</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <nav class="breadcrumb-container" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">View User Role</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header"><h3>View User Role</h3></div>
                                <div class="card-body">
                                    <form method="post">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" disabled name="role_name" class="form-control" value = "<?=$role[0]['role_name']?>" placeholder="eg. Administrator">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" disabled name="description" placeholder="eg. Has access to all privileges" class="form-control"><?=$role[0]['description']?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="checkbox-fade fade-in-primary">
                                                                <label>
                                                                    <input disabled class="perms" type="checkbox" id="perm_id_<?=$role_permissions[$i]['perm_id']?>"
