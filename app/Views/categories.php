                                ...
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a loading="true" href="<?= base_url(); ?>/products">Categories</a></li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12 table-responsive">
                                        ...
                                        <?php if (is_array($categories)): ?>
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr id="category<?=$row['cat_id']?>" ><?php if (!empty($row['cat_image'])): ?>
                                                            <td><img id="img<?=$row['cat_id']?>" src="<?=$row['cat_image']?>" class="table-user-thumb" alt=""></td>
                                                        <?php else: ?>
                                                            <td><img id="img<?=$row['cat_id']?>" src="<?=base_url()?>/public/img/uploads/products/product-default-image.png" class="table-user-thumb" alt=""></td>
                                                        <?php endif; ?>
                                                        <td id="cat<?=$row['cat_id']?>"><?=$row['cat_name']?></td>
                                                        <td><?=$row['description']?></td>
                                                        <td><span class="btn" style="background-color: <?=$row['cat_color']?>"></span></td>
                                                        <td>
                                                            <div class="table-actions">
                                                                <a loading="true" href="<?= base_url(); ?>/products/view_category/<?= $row['cat_id'] ?>"><i
