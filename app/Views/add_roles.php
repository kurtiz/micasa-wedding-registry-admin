                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    ...
                                    <div class="d-inline">
                                        <h5>Add User Role</h5>
                                        <span>Add user roles to your shop</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <nav class="breadcrumb-container" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a loading="true" href="<?= base_url(); ?>/roles">Roles</a></li>
                                    ...
                                    <form method="post" id="role-form">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" name="description" placeholder="eg. Has access to all privileges"
                                        ...
                                        <div class="row">
                                            <?php if (is_array($role_permissions)): ?>
                                                <?php foreach($role_permissions as $row): ?>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="checkbox-fade fade-in-primary">
                                                                <label>
                                                                    <input class="perms" type="checkbox" id="perm_id_<?=$row['perm_id']?>"
                                                                           onClick="setCheckedValue('#perm_id_text_<?=$row['perm_id']?>','#perm_id_<?=$row['perm_id']?>')"
                                                                           name="">

                                                                    <span class="cr">
                                                                        <i class="cr-icon ik ik-check txt-primary"></i>
                                                                        <input hidden type="text" value="false" class="permsOut"
                                                                               id="perm_id_text_<?=$row['perm_id']?>"
                                                                               name="permission[]">
                                                                    </span>
                                                                    <span>
                                                                        <?= $row['perm_mod'] ?> : <?= $row['perm_desc'] ?>
                                                                    </span>
                                                                </label>
                                                            </div>
                                                        </div>
